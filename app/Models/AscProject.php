...
class AscProject extends Project{
       
	//use Auditable; 
	   
	protected $model_title = "ASC Project";
    ...
    {
        return $this->hasMany('App\Models\AscProjectPartnerBill', 'project_id');
    }
	...
	public function requirements(){	
		$req[] = 'Club Leaders should be eneter minimum '.count($this->center_incharges).'/8';
		return $req;
	}
