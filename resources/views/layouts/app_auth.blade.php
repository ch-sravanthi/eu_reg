@include('layouts.header')
	...
	<style>
		...
		//	background: linear-gradient(to bottom, #a5991f, #ccca44);
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav  mb-lg-0 ml-1">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="#"> <i class="bi bi-card-checklist"></i>  List</a>
					</li>	
				</ul>
				&nbsp;&nbsp;&nbsp;
				<ul class="navbar-nav  mb-lg-0 ml-1">
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownFavorites" style="background-color:#0e98e9;">
							<li><a class="dropdown-item" href="#" style="background-color:#0e98e9;"><i class="bi bi-card-checklist"></i> &nbsp;Check</a></li>
