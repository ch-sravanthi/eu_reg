@include('layouts.header')
	<style>
		...
		//	background: linear-gradient(to bottom, #bb2514, #782607);
			background: linear-gradient(to bottom, #25d6ab, #1d0e85); 
		}
		.btn:hover{
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#fff; border-bottom: 2px solid #678bbd11; font-weight: 500;">
		<div class="container-fluid">
			<a class="navbar-brand" href="https://uesits.com/"><img class="rounded" src="{{ asset('images/logo.png') }}" height="50"></a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 d-sm-none d-md-block">
					<li class="nav-item" style="color:#fff;">
						<a class="nav-link active" aria-current="page" href="#" >Welcome To EGF Reports</a>
					</li>
				</ul>
				...
				<ul class="navbar-nav  mb-lg-0 ml-1">
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownFavorites" style="background-color:#0e98e9;">
							<li><a class="dropdown-item" href="#" style="background-color:#0e98e9;"><i class="bi bi-card-checklist"></i> &nbsp;Login</a></li>
