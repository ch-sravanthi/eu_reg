		...
		<div class=" row p-4 bg-light">
			...
			<div class="row p-4 bg-light">
				...
				<div class="col-lg-4 p-2 bg-light">
					<b>UESI Publication Trust<br>
					<br> Account Details</b>
			...
			<div class="row mt-4 p-2">
				...
				<div class="col-lg-6 p-3">
					...
					<label class="text-dark">{{ $new_subscription->nicenames['type_of_subscription'] }}  * </label>
						{!! EasyForm::radio('type_of_subscription', '', old('type_of_subscription', $new_subscription->type_of_subscription), AppHelper::options('type_renewal')) !!}
