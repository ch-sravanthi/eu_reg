	...
	<div class="row text-center">
		...
		<div class="col-lg-4 mb-2">
			<div class="card bg-primary text-white" style="height:120px;">
				<div class="card-body" style="padding-top:50px;padding-bottom:50px;">  <a style="color:white; font-size:22px; " href="{{route('new_subscription.create_new')}}">SUBSCRIPTION <div class="text-gray small pt-3">(New/Renewal)</div></a></div>
			</div>
		</div>
		<div class="col-lg-4 mb-2">
	...
	<div class="text-center py-2" style= "background-color: #fbfbfb;border-top: 1px solid #bebbd7;">
		<div class="row">
			<div class="col-lg-12">
				...
				Copyright @ UESI Publication Trust, Telangana Branch. All rights reserved.  <img src="https://uesitelengana.uesits.com/images/vv.jpeg" style="width:80px;height:70px;"> 
				<?php //echo date("Y");?> </b>
			</div>
		</div>
	</div>
