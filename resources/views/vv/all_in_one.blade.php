	...
	<div class="text-center py-2" style= "background-color: #fbfbfb;border-top: 1px solid #bebbd7;">
		<div class="row">
			<div class="col-lg-12">
				...
				Copyright @ UESI Publication Trust, Telangana Branch. All rights reserved.  <img src="https://uesitelengana.uesits.com/images/vv.png" style="width:80px;height:70px;"> 
				<?php //echo date("Y");?> </b>
			</div>
		</div>
	</div>
