...
<div class="py-3">
	<div class="row bill">
		<div class="col col-12 col-lg-3">											
			{!! Form::select('term[]', ['' =>'Select Purpose']+AppHelper::options($arr[0].'_'.$arr[1].'_indent_category_terms'), $project_partner_bill_record->term, ['required' => true, 'onchange' => 'updateAttachment(this)']) !!}														
		</div>
		<div class="col col-12 col-lg-3">	
