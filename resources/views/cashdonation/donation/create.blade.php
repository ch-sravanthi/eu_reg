...
<div class="row">
	...
	<div class="col col-12 col-md-6 col-lg-3">				
		{!!  Form::select('donation_received_through', ['' =>'Select Type']+AppHelper::options('donation_types'), null,  ['id' => 'donation_received_through', 'required' => true]) !!}		
	</div>	
	
	<div class="col col-12 col-md-6 col-lg-3">				
		{!!  Form::select('language', ['' =>'Preferred Reading Language'], null, ['id' => 'language']) !!}									
		{!! FormHelper::dependentScript('language', old('language', ''), AppHelper::options('our_cash_languages'), 'donation_received_through', '') !!}
	</div>	
	
	<div class="col col-12 col-md-6 col-lg-3">				
		{!! Form::number('amount', $donation->amount, ['placeholder' => 'Amount', 'required' => true]) !!}
	</div>
</div>
